...
namespace JxAlignVision
{
    public class CfgApp :ModConfig
    {
        ...
        [Category("B-WPC设备"), DisplayName("[BWPC01]WPC相机1"), Description("")]
        public string WpcCam1 { get; set; } = "1";
        [Category("B-WPC设备"), DisplayName("[BWPC02]WPC相机1图像旋转"), Description("")]
        public RotateFlipType WpcSysImgRotateFilp1 { get; set; } = RotateFlipType.RotateNoneFlipNone;
        [Category("B-WPC设备"), DisplayName("[BWPC03]WPC相机2"), Description("")]
        public string WpcCam2 { get; set; } = "2";
        [Category("B-WPC设备"), DisplayName("[BWPC04]WPC相机2图像旋转"), Description("")]
        public RotateFlipType WpcSysImgRotateFilp2 { get; set; } = RotateFlipType.RotateNoneFlipNone;
        [Category("B-WPC设备"), DisplayName("[BWPC05]WPC PLC通讯类型"), Description("")]
        public PlcDriverType WpcPlcType { get; set; } = PlcDriverType.Hsl;
        [Category("B-WPC设备"), DisplayName("[BWPC06]WPC PLCIP地址"), Description("")]
        public string WpcPlcIp { get; set; } = "192.168.0.10";
        [Category("B-WPC设备"), DisplayName("[BWPC07]WPC PLC端口号"), Description("")]
        public int WpcPlcPort { get; set; } = 5000;
        [Category("B-WPC设备"), DisplayName("[BWPC08]WPC PLC站点号"), Description("")]
        public int WpcMxStation { get; set; } = 1;
        [Category("B-WPC设备"), DisplayName("[BWPC09]心跳点位"), Description("")]
        public string WpcPlcHeartDog { get; set; } = "D9600";

        [Category("B-EOL设备"), DisplayName("[BEOL01]EOL产品相机"), Description("")]
        public string EolPordCam { get; set; } = "1";
        [Category("B-EOL设备"), DisplayName("[BEOL02]EOL产品相机图像旋转"), Description("")]
        public RotateFlipType EolProdSysImgRotateFilp { get; set; } = RotateFlipType.RotateNoneFlipNone;
        [Category("B-EOL设备"), DisplayName("[BEOL03]EOL治具相机"), Description("")]
        public string EolJigCam { get; set; } = "1";
        [Category("B-EOL设备"), DisplayName("[BEOL04]EOL治具相机图像旋转"), Description("")]
        public RotateFlipType EolJigSysImgRotateFilp { get; set; } = RotateFlipType.RotateNoneFlipNone;
        [Category("B-EOL设备"), DisplayName("[BEOL05]EOL PLC通讯类型"), Description("")]
        public PlcDriverType EolPlcType { get; set; } = PlcDriverType.Hsl;
        [Category("B-EOL设备"), DisplayName("[BEOL06]EOL PLCIP地址"), Description("")]
        public string EolPlcIp { get; set; } = "192.168.0.10";
        [Category("B-EOL设备"), DisplayName("[BEOL07]EOL PLC端口号"), Description("")]
        public int EolPlcPort { get; set; } = 5000;
        [Category("B-EOL设备"), DisplayName("[BEOL08]EOL PLC站点号"), Description("")]
        public int EolMxStation { get; set; } = 1;
        [Category("B-EOL设备"), DisplayName("[BEOL09]心跳点位"), Description("")]
        public string EolPlcHeartDog { get; set; } = "D9600";


        [Category("B-EOLCS设备"), DisplayName("[BEOLCS01]EOL读码&点亮相机"), Description("")]
        public string EolCodeSignCam { get; set; } = "1";
        [Category("B-EOLCS设备"), DisplayName("[BEOLCS02]EOL读码&点亮相机图像旋转"), Description("")]
        public RotateFlipType EolCodeSignSysImgRotateFilp { get; set; } = RotateFlipType.RotateNoneFlipNone;
        [Category("B-EOLCS设备"), DisplayName("[BEOLCS03]WPC PLC通讯类型"), Description("")]
        public PlcDriverType EolCsPlcType { get; set; } = PlcDriverType.Hsl;
        [Category("B-EOLCS设备"), DisplayName("[BEOLCS04]WPC PLCIP地址"), Description("")]
        public string EolCsPlcIp { get; set; } = "192.168.0.10";
        [Category("B-EOLCS设备"), DisplayName("[BEOLCS05]WPC PLC端口号"), Description("")]
        public int EolCsPort { get; set; } = 5000;
        [Category("B-EOLCS设备"), DisplayName("[BEOLCS06]WPC PLC站点号"), Description("")]
        public int EolCsMxStation { get; set; } = 1;
        [Category("B-EOLCS设备"), DisplayName("[BEOLCS07]心跳点位"), Description("")]
        public string EolCsPlcHeartDog { get; set; } = "D9600";


        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC01]点亮触发1"), Description("")]
        public string WpcPlcProdSignTrigger1 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC02]点亮结果1"), Description("")]
        public string WpcPlcProdSignResult1 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC03]读码触发1"), Description("")]
        public string WpcPlcProdCodeTrigger1 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC04]读码结果1"), Description("")]
        public string WpcPlcProdCodeResult1 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC05]读码写入地址1"), Description("")]
        public string WpcPlcProdCodeAds1 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC06]点亮触发2"), Description("")]
        public string WpcPlcProdSignTrigger2 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC07]点亮结果2"), Description("")]
        public string WpcPlcProdSignResult2 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC08]读码触发1"), Description("")]
        public string WpcPlcProdCodeTrigger2 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC09]读码结果2"), Description("")]
        public string WpcPlcProdCodeResult2 { get; set; } = "D9000";
        [Category("C-WPC Plc点位设置"), DisplayName("[CWPC10]读码写入地址2"), Description("")]
        public string WpcPlcProdCodeAds2 { get; set; } = "D9000";

        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL01]产品对位信号"), Description("")]
        public string EolProdAlignTrigger { get; set; } = "D9000";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL02]产品对位结果"), Description("")]
        public string EolProdAlignResult { get; set; } = "D9001";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL03]治具对位信号"), Description("")]
        public string EolJigAlignTrigger { get; set; } = "D9000";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL04]治具对位结果"), Description("")]
        public string EolJigAlignResult { get; set; } = "D9001";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL05]联合计算信号"), Description("")]
        public string EolCalcAlignTrigger { get; set; } = "D9000";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL06]联合计算结果"), Description("")]
        public string EolCalcAlignResult { get; set; } = "D9001";


        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL07]产品对位结果offset-X"), Description("")]
        public string EolAlignPosX { get; set; } = "D9010";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL08]产品对位结果offset-Y"), Description("")]
        public string EolAlignPosY { get; set; } = "D9014";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL09]产品对位结果offset-R"), Description("")]
        public string EolAlignPosR { get; set; } = "D9012";

        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL10]机器人放置基准X值"), Description("")]
        public string EolTarBaseX { get; set; } = "D9500";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL11]机器人放置基准Y值"), Description("")]
        public string EolTarBaseY { get; set; } = "D9504";
        [Category("C-EOL Plc点位设置"), DisplayName("[CEOL12]机器人放置基准R值"), Description("")]
        public string EolTarBaseR { get; set; } = "D9502";

        [Category("C-EOL Plc点位设置"), DisplayName("[C08]机器人当前X值"), Description("")]
        public string EolRobotCurX { get; set; } = "D9500";
        [Category("C-EOL Plc点位设置"), DisplayName("[C09]机器人当前Y值"), Description("")]
        public string EolRobotCurY { get; set; } = "D9504";
        [Category("C-EOL Plc点位设置"), DisplayName("[C10]机器人当前R值"), Description("")]
        public string EolRobotCurR { get; set; } = "D9502";

        [Category("C-EOL Plc点位设置"), DisplayName("[C11]机器人移动X值"), Description("")]
        public string EolRobotMoveX { get; set; } = "D9506";
        [Category("C-EOL Plc点位设置"), DisplayName("[C12]机器人移动Y值"), Description("")]
        public string EolRobotMoveY { get; set; } = "D9510";
        [Category("C-EOL Plc点位设置"), DisplayName("[C13]机器人移动R值"), Description("")]
        public string EolRobotMoveR { get; set; } = "D9508";
        [Category("C-EOL Plc点位设置"), DisplayName("[C14]机器人移动标志位"), Description("")]
        public string EolRobotMoveFlag { get; set; } = "D9512";

        [Category("C-EOL Plc点位设置"), DisplayName("[C15]PLC补偿轴X读写取反"), Description("标定前修改，标定后不可随意修改")]
        public bool EolXNegation { get; set; } = false;
        [Category("C-EOL Plc点位设置"), DisplayName("[C16]PLC补偿轴Y读写取反"), Description("标定前修改，标定后不可随意修改")]
        public bool EolYNegation { get; set; } = false;
        [Category("C-EOL Plc点位设置"), DisplayName("[C17]PLC补偿轴R读写取反"), Description("标定前修改，标定后不可随意修改")]
        public bool EolRNegation { get; set; } = false;

        [Category("C-EOL CS Plc点位设置"), DisplayName("[CEOLCS01]点亮触发"), Description("")]
        public string EolPlcProductSignTrigger { get; set; } = "D9000";
        [Category("C-EOL CS Plc点位设置"), DisplayName("[CEOLCS02]点亮结果"), Description("")]
        public string EolPlcProductSignResult { get; set; } = "D9000";
        [Category("C-EOL CS Plc点位设置"), DisplayName("[CEOLCS03]读码触发"), Description("")]
        public string EolPlcProductCodeTrigger { get; set; } = "D9000";
        [Category("C-EOL CS Plc点位设置"), DisplayName("[CEOLCS04]读码结果"), Description("")]
        public string EolPlcProductCodeResult { get; set; } = "D9000";
        [Category("C-EOL CS Plc点位设置"), DisplayName("[CEOLCS05]读码写入地址"), Description("")]
